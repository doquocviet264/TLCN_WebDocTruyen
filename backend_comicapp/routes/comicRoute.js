...
const {getHomepageSections, getComicDetails, toggleFollow, getNewlyUpdatedComics, getFeaturedComics, getRankings, getComicDetailForHistory, searchComics} = require('../controllers/comicController.js');
